...
% No (STDP + hLTP) learning.

function IFmodelNoLearning(rin, rin_min, eta, epsilon, wmax, IFinputs)
    ...
    filename=strcat('rin_',num2str(rin),' eta_',num2str(eta),' epsilon_',num2str(epsilon),' wmax_',num2str(wmax),' nolearning.mat');
    save(filename)
end