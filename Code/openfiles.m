function openfiles(numFiles, Fileset)
    for file = 1:numFiles
        ...
        savefig(['Bursts: rin_',num2str(rin), 'eta_', num2str(eta), 'epsilon_', num2str(epsilon), '.fig']);
        colorbar       
        ...
        savefig(['Weightsnorm: rin_',num2str(rin), 'eta_', num2str(eta), 'epsilon_', num2str(epsilon), '.fig']);
        colorbar
